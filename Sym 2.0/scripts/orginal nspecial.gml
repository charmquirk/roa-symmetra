...
//set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("orb_shoot"));
...
//set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 64);
//set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 64);
